            ...
            <Card style={{ marginBottom: "10px" }}>
              <Card.Body className={style.responsiveCard}>
                <div class="d-flex bd-highlight">
                  ...
                  <div class="p-2 bd-highlight mt-2" style={{ width: "65px" }}>
                    <strong>Ralph</strong>
                  </div>
                  <div class="p-2 bd-highlight mt-2" style={{ width: "110px" }}>
                    <strong>32 Years old</strong>
                  </div>
                  <div class="p-2 bd-highlight mt-2" style={{ width: "130px" }}>
                    <strong>710481048018</strong>
                  </div>
