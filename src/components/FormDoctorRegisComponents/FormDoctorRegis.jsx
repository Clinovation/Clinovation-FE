...
import useValidateForm from '../../hooks/doctor/useValidateForm'
                ...
                <Form.Group as={Row} className="mb-3" controlId="formPlaintextEmail">
                  ...
                  <Col md="9">
                    ...
                    <Form.Select 
                        ...
                        onChange={onChange}
                    >
                      <option value="Sunday-Wednesday-Friday">Sunday-Wednesday-Friday</option>
                      <option value="Tuesday-Wednesday-Saturday">Tuesday-Wednesday-Saturday</option>
                    </Form.Select>
                  </Col>
                </Form.Group>
